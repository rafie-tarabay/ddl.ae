...
|
*/
$config['encryption_key'] = 'ddlapi'; // api
...
$config['sess_cookie_name'] = 'ci_ddlapi';
$config['sess_expiration'] = 60*60*24*365; // full year
$config['sess_save_path'] = FCPATH ."storage/sessions/api/";
...
|
*/
$config['cookie_prefix']	= 'ddlapi_'; // api
...
$config['csrf_cookie_name'] = 'csrf_ddlapi';
