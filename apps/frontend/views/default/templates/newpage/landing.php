<div class="row pb-3">
    ...
    <div class="col-md-12">
        <?php $this->load->view(style.'/templates/newpage/parts/special_libraries' , array("content"=>$content) );   ?>   
    </div>
               
    <div class="col-md-12">
        <?php $this->load->view(style.'/templates/newpage/parts/partners_libraries' , array("content"=>$content) );   ?>
    </div>              
