    ...
    <div class="card-header bg-gray-dark head nice-font">
        <div class="row no-gutters">
            <?php if (OppAlign ==  "left") : ?>
                <i class="fa fa-caret-<?php echo OppAlign; ?>"></i> &nbsp; <?php echo "تصفح المحتوى الرقمي حسب التصنيف" ?>
            <?php else : ?>
...
<?php if(isset($latest_logs) && !empty($latest_logs)){?>
...
<div class="card bg-light" id="live_visiting">
    ...
    <div class="list-group list-group-flush" id="live_visiting_container">
        ...
        foreach ($latest_logs as $log) { ?>
            ...
            <div class="list-group-item p-2 book_<?php if(isset($book->id)){  echo $book->id;} ?>">
                <div class="small">
                    <a target="_blank" href="<?php if(isset($book->id)){ echo base_url(front_base . "book/" . $book->id);} ?>">
                        <i class="fa fa-caret-<?php echo OppAlign; ?> text-info"></i> <?php if(isset($book->title)){  echo $book->title;} ?>
                    </a>
                </div>
