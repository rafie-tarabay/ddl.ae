    ...
    <table class="table table-light table-hover table-bordered" >
        ...
        <?php foreach($records as $record){ ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <?php echo word($record->corp_status) ?>
                </td>             
                
                <td class="text-center">                    
                    <a class="btn btn-info btn-sm" href="<?php echo base_url(admin_base."publishing/view_corp/".$record->corp_id) ?>">البيانات</a>
                </td>                                                   
